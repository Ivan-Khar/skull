...
class Common: Config(
    ...
    class SkullSection: ConfigSection() {
        ...
        @Translatable.Name("Respawn when disappeared")
        @Translatable.Desc("Skull respawns at spawn point after disappearing")
        var respawnOnDisappear = ValidatedBoolean(false)
